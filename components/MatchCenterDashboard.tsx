        ...
        <header className="flex flex-col gap-6 rounded-[32px] bg-[#EDF2F7] p-6 shadow-[5px_5px_10px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.8)] md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center justify-between gap-4 rounded-[28px] bg-[#F4F8FF] p-3 shadow-[5px_5px_10px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.8)] md:w-auto md:px-5">
            <div className="flex flex-col">
              <span className="text-xs uppercase tracking-[0.34em] text-slate-500">Welcome back</span>
          ...
          <article className="rounded-[32px] bg-[#EDF2F7] p-6 shadow-[5px_5px_10px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.8)]">
            <div className="flex items-center justify-between">
              ...
              <div className="flex h-11 w-11 items-center justify-center rounded-3xl bg-white shadow-[5px_5px_12px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_12px_rgba(255,255,255,0.8)]">
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-[#6CABDD]">
                  <path fill="currentColor" d="M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 2a7 7 0 017 7c0 1.9-.84 3.62-2.18 4.82L7.18 7.18A6.975 6.975 0 0112 5zm-5.82 2.18L16.82 18.82A6.975 6.975 0 015 12c0-1.9.84-3.62 2.18-4.82z" />
                </svg>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-6">
              <div className="rounded-[32px] bg-[#F4F8FF] p-5 shadow-[5px_5px_10px_rgba(0,0,0,0.04)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.9)]">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    ...
                    <h3 className="mt-3 text-xl font-semibold">Man City vs {matchCenter.lastMatch.opponent}</h3>
                  </div>
                  <span className="rounded-3xl bg-[#6CABDD] px-4 py-2 text-sm font-semibold text-white shadow-[5px_5px_10px_rgba(0,0,0,0.08)]">{matchCenter.lastMatch.score}</span>
                </div>
              ...
              <div className="rounded-[32px] bg-[#F4F8FF] p-5 shadow-[5px_5px_10px_rgba(0,0,0,0.04)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.9)]">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Upcoming Match</p>
                    <h3 className="mt-3 text-xl font-semibold">Man City vs {matchCenter.upcomingMatch.opponent}</h3>
                  </div>
          ...
          <article className="rounded-[32px] bg-[#EDF2F7] p-6 shadow-[5px_5px_10px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.8)]">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-3xl bg-white p-3 shadow-[5px_5px_10px_rgba(0,0,0,0.06)] shadow-[-5px_-5px_10px_rgba(255,255,255,0.8)]">
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-[#6CABDD]">
                  <path fill="currentColor" d="M12 2C7.59 2 4 5.59 4 10c0 4.86 6 11 8 11s8-6.14 8-11c0-4.41-3.59-8-8-8zm0 17.27C9.01 17.69 6 12.78 6 10c0-3.31 2.69-6 6-6s6 2.69 6 6c0 2.78-3.01 7.69-6 9.27z" />
              ...
              <div className="relative h-[420px] sm:h-[440px]">
                {matchCenter.formation.map((player) => (
                  ...
                  >
                    ...
                    <span className="mt-1 text-[10px] uppercase tracking-[0.2em] text-slate-500">{player.shortName}</span>
                  </div>
                ))}
              </div>
                  ...
                  <div className="mt-4 space-y-3 text-sm text-slate-600">
                    <div>
                      ...
                      <div className="mt-2 h-2 rounded-full bg-[#D8E8F8]">
                        <div className="h-2 rounded-full bg-[#6CABDD]" style={{ width: `${player.goalPercent}%` }} />
                      </div>
                    </div>
                    <div>
                      <div className="flex items-center justify-between">
                        <span>Assists</span>
                        <span className="font-semibold text-[#1C2C5B]">{player.assistPercent}%</span>
                      </div>
                      <div className="mt-2 h-2 rounded-full bg-[#D8E8F8]">
                        <div className="h-2 rounded-full bg-[#1C2C5B]" style={{ width: `${player.assistPercent}%` }} />
                      </div>
                    </div>
                  </div>
                </div>
